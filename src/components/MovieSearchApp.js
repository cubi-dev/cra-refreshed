...
// https://api.themoviedb.org/3/movie/157336?api_key=d1f1dc29274f4a7a406e1163862f55f2
// https://api.themoviedb.org/3/search/movie?api_key=d1f1dc29274f4a7a406e1163862f55f2&query=""
const MovieSearchApp = () => {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      const response = await axios.get(
        `https://api.themoviedb.org/3/search/movie?api_key=d1f1dc29274f4a7a406e1163862f55f2&query='${queryDebounce}'`
      );
  ...
  return (
    <div className="p-10">
      <div className="width-full max-w-[500px] mx-auto mb-20">
        <input
          type="text"
    ...
    <div className="bg-white p-3 rounded-2xl shadow-sm flex flex-col">
      ...
      <div className="p-7 flex-1 flex flex-col">
        ...
        <div className="text-[#999] text-sm mb-6 !leading-loose">
          ...
          <div className="h-2" radius="16px"></div>
          <LoadingSkeleton height="10px"></LoadingSkeleton>
          <div className="h-2" radius="16px"></div>
          <LoadingSkeleton height="10px"></LoadingSkeleton>
          <div className="h-2" radius="16px"></div>
